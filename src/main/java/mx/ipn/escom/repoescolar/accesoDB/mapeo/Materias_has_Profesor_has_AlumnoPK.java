...
/**
 * The primary key class for the Materias_has_Profesor_has_Alumno database table.
 * 
 */
@Embeddable
public class Materias_has_Profesor_has_AlumnoPK implements Serializable {
	...
	public Materias_has_Profesor_has_AlumnoPK() {
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof Materias_has_Profesor_has_AlumnoPK)) {
			return false;
		}
		Materias_has_Profesor_has_AlumnoPK castOther = (Materias_has_Profesor_has_AlumnoPK)other;
		return 
