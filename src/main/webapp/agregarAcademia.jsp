...
<body>
	...
	<div class="contenido centrar">
		<div class="contenedorCentral centrar">
			<h3>Academias registradas</h3>
			<form action="Acciones?accion=24&direccion=agregarAcademia.jsp" method="POST" style="width: 80%;" class="centrar">
				<table>
					<thead>
						<tr>
							<th>Nombre</th>
					...
					<tbody>
						<c:forEach items="${academias}" var="academia">
							<tr>
								...
								<td><input type="checkbox" value="${academia.idAcademias}" name="academiaAEliminar" class="centrar"></td>
							</tr>
						</c:forEach>
					</tbody>
					<tfoot>
						<tr>
							<th colspan="2"><input type="submit" value="Eliminar academia" class="centrar botonConfirm"></th>
						</tr>
					</tfoot>
				</table>
			</form>
			<h3>Agregar academia</h3>
			<form action="Acciones?accion=23&direccion=agregarAcademia.jsp" method="POST" style="width: 80%;" class="centrar">
				<div id="contieneAcademias">
					<div id="academia">
						<input type="text" maxlength="45" minlength="5" placeholder="Nombre de academia" name="academiaNueva" required>
					</div>
				</div>
				<input type="button" value="Agregar otra acadmeia" onclick="duplicaElemento('academia','contieneAcademias')" class="centrar botonConfirm">
